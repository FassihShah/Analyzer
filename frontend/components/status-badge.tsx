...
const styles: Record<string, string> = {
  active: "border-[#b9dcd4] bg-[#eaf6f2] text-[#1c6255]",
  archived: "border-[#d1dbd8] bg-[#f4f7f6] text-[#56635f]",
  paused: "border-[#f0d892] bg-[#fff7dd] text-[#765a11]",
...
export function StatusBadge({ value }: { value?: string }) {
  ...
  return <span className={cn("inline-flex whitespace-nowrap rounded-full border px-2.5 py-1 text-xs font-semibold capitalize", styles[label] ?? styles.pending)}>{label.replaceAll("_", " ")}</span>;
}
